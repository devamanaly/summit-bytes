...
const Foot = () => {
    return (
        <div className='h-[388px] w-full bg-[#093F68] flex justify-center items-center gap-x-[144px]'>
            <div className='h-[388px] min-w-20 bg-[#093F68] flex justify-center items-center gap-x-8'>
                ...
                <div className='w-[349px] min-h-52  flex flex-col justify-start items-start gap-y-8'>
                    ...
                    <div className='flex flex-col justify-start items-start gap-y-5'>
                        ...
                        <div className='flex flex-row justify-start items-center gap-x-11'>
                            ...
                            <p className='text-[20px] text-[#B5B5B5]' >03443353402</p>
                        ...
                        <div className='flex flex-row justify-start items-center gap-x-11'>
                            ...
                            <p className='text-[20px] text-[#B5B5B5]' >summitbytes@gmail.com</p>
                        ...
                        <div className='flex flex-row justify-start items-center gap-x-11'>
                            ...
                            <p className='text-[20px] text-[#B5B5B5]' >132 Dartmouth Street Boston, Massachusetts 02156 United States</p>
                ...
                <div className='min-h-52 min-w-[39px] flex flex-col justify-start items-start gap-y-8 ' >
                    ...
                    <div className='flex flex-col gap-y-5' >
                        <a href="#" className='text-[20px] text-[#B5B5B5]'>About</a>
                        <a href="#" className='text-[20px] text-[#B5B5B5]'>Services</a>
                        <a href="#" className='text-[20px] text-[#B5B5B5]'>Features</a>
                        <a href="#" className='text-[20px] text-[#B5B5B5]'>Blogs</a>
                ...
                <div className='min-h-52 min-w-[39px] flex flex-col justify-start items-start gap-y-8 ' >
                    ...
                    <div className='flex flex-col gap-y-5' >
                        <a href="#" className='text-[20px] text-[#B5B5B5]'>Privacy policy</a>
                        <a href="#" className='text-[20px] text-[#B5B5B5]'>Terms & Services</a>
                        <a href="#" className='text-[20px] text-[#B5B5B5]'>Term of use</a>
                        <a href="#" className='text-[20px] text-[#B5B5B5]'>Refund policy</a>
                ...
                <div className='min-h-52 min-w-[39px] flex flex-col justify-start items-start gap-y-8 ' >
                    ...
                    <div className='flex flex-col gap-y-5' >
                        <a href="#" className='text-[20px] text-[#B5B5B5]'>Downloads</a>
                        <a href="#" className='text-[20px] text-[#B5B5B5]'>Forum</a>
                        <a href="#" className='text-[20px] text-[#B5B5B5]'>Techlabz Keybox</a>
                        <a href="#" className='text-[20px] text-[#B5B5B5]'>Blogs</a>
            ...
            <div className='w-[349px] h-[249px] bg-[#0A0077] rounded-[20px] flex flex-col justify-center gap-y-14' style={{ paddingLeft: "24px" }}>
                <h4 className='text-[20px] font-normal text-white '>Join Our Newsletter</h4>
