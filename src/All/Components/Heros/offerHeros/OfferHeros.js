  ...
  return (
    <div className='w-[100vw] h-[85vh] offer-heros flex flex-row justify-center items-center gap-x-5 '>
      ...
      <div className='offer-left  w-[665px] h-[310px] flex flex-col justify-start gap-y-3 '>
        <p className='text-[#FFFFF0] xlg:text-[63px] xl:text-[56px] font-bold  'data-aos="fade-down" >Hire pre-vetted,top-tier</p>
        <p className='text-[#00759F] xlg:text-[63px] xl:text-[56px] font-bold 'data-aos="fade-down" >
          Web developers</p>

        <p className='text-[#8492A6] text-[17px] font-semibold ' data-aos="fade-up">Elevate your business with our comprehensive services.Starting at $1500/mo, we offer software development,marketing, UX/UI and more to optimize your operationsand
