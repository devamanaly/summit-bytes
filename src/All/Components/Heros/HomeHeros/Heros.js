...
const Heros = () => {
  ...
  return (
    <div>
      <div
        className=" heros-main w-[100vw]  h-[100vh]  flex flex-col justify-center items-center gap-y-5"

      >

        {/* Text Start */}

        <p className="text-white w-[80%] text-popins  xl:text-[56px] text-[24px] sm:text-[36px] md:text-[42px] xlg:text-[63px] md:min-h-[200px] min-h-[50px] md:font-semibold sm:font-normal leading-normal   text-center " data-aos="fade-down">
        ...
        {/* buttons start*/}
        <div className="flex flex-col md:flex-row justify-center items-center mt-11 md:mt-5 gap-x-4 gap-y-7" data-aos="fade-up">
